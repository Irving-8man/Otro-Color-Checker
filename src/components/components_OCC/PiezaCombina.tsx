...
export default function PiezaCombinacion({
    ...
    return (
        <td
            className={`border border-gray-300 px-5 py-5 min-h-[100px] min-w-[20px] text-center relative ${(combinacion.esMismoColor) && "ee"}`}
            style={bgColor}
        >
            ...
            {!combinacion.esMismoColor && (
                ...
                resultados[0].ratio === ratioIdentico ? (
                    ...
                    <DialogInfo resultados={resultados} combinacion={combinacion}>
                        <button className="flex flex-col items-center gap-2 pd w-full">
